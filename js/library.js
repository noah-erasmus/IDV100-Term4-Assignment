$(function(){
    ...
    apiRequest.onload = function(){
        ...
        function createEntries(poster_path, original_title, vote_average, genre_ids, release_date){
            $(".entry-line").append("<div class='entry col-xs-4 col-sm-2 col-md-2 col-lg-2'><div class='overlay'><h3 class='entry-rating'>" + vote_average + "</h3><h3 class='entry-genre'>" + genre_ids + "</h3><div class='overlay-btns'><a class='#MOVIE'><div class='read-more-btn'><p>Read <br>More</p></div></a><a href='#WATCHLIST'><div class='add-watchlist-btn'><p>Add to <br>Watchlist</p></div></a></div></div><div class='entry-poster'><img src='" + poster_path + "'></div><div class='entry-details'><p class='entry-title'>" + original_title + "</p><p class='entry-release'>" + release_date + "</p></div></div>");
        }
